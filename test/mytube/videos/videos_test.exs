defmodule Mytube.VideosTest do
  use Mytube.DataCase
  ...
  describe "videos" do
    ...
    @valid_attrs %{duration: "some duration", thumbnail: "some thumbnail", title: "some title", video_id: "some video_id"}
    @update_attrs %{duration: "some updated duration", thumbnail: "some updated thumbnail", title: "some updated title", video_id: "some updated video_id"}
    @invalid_attrs %{duration: nil, thumbnail: nil, title: nil, video_id: nil}
